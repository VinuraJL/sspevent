<div class="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm">
    ...
    <div class="p-5">
        <a href="#">
            <h5 class="text-gray-900 font-bold text-2xl tracking-tight mb-2">Book reading Event
                </h5>
        </a>
        <p class="font-normal text-gray-700 mb-3 dark:text-gray-400">One of our community favorite book reading events coming up</p>
